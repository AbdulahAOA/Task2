    ...
    <div class="container mt-4">
        <div class="glass-card card">
            <div class="card-header">
                <h4><i class="fa-solid fa-palette"></i> Color Information</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('colors.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name_ar" class="form-control-custom"
                                   placeholder="اسم اللون" value="{{ old('name_ar') }}">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name_en" class="form-control-custom"
                                   placeholder="Color Name" value="{{ old('name_en') }}">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <input type="color" name="color_code" class="form-control-custom"
                                       ...
                                       value="{{ old('color_code', '#ffc107') }}">
                                <span id="colorCodeDisplay" style="color:rgba(255,255,255,0.5);">#ffc107</span>
                            </div>
                        </div>
                    ...
                    <button type="submit" class="btn-save">
                        <i class="fa-regular fa-floppy-disk me-2"></i> Save Color
                    </button>
                </form>
            </div>
        </div>
